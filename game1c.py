...
if __name__ == '__main__':
    ...
    if  weapon_1 == chest_item1 or weapon_1 == chest_item2:   # delete this line
        print ('\nGreat!')  # change this to:  print ('\nGreat!')
    ...
    print ('\nyour main weapon is %s and your secondary is %s' %(weapon_1, secondary) )  # this is the python2 style way, still useful
